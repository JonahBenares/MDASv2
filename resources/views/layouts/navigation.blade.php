    ...
    <div class="flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-white md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white white:bg-gray-800 md:white:bg-gray-900 white:border-gray-700">
                <li>
                    <a href="{{ route('dashboard.index') }}" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 white:text-white" aria-current="page" title="Home" data-tooltip-target="tooltip-default">
                ...
                <li>
                    ...
                    <div id="dropdownNavReports" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-auto white:bg-gray-700 white:divide-gray-600">
                        ...
                        <ul class="py-2 text-sm text-gray-700 white:text-gray-400" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                                <a href="{{ route('reportregionalweekly.index') }}" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Regional Summary <b>(Weekly)</b></a>
                            </li>
                            <li>
                                <a href="{{ route('reportactualoutages.index') }}" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Actual Outages</a>
                            </li>
                            <li>
                                <a href="{{ route('reportoutagestype.index') }}" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Outages Per Type </b>(Graph)</b></a>
                            </li>
                        </ul>
                    </div>
                </li>
