<x-app-layout>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            <div class="text-lg  font-medium uppercase py-2">Price Nodes <span class="bg-indigo-500 rounded-2xl p-1 px-2 font-bold text-white text-xs">Update</span></div>
            <div class="">
                <a href="{{ route('pricenodes.index') }}" class=""> 
        ...
        <div class="relative overflow-x-auto border-b mb-2 pb-4">
            ...
            @endif
            <form action="{{ route('pricenodes.update',$price_nodes->id) }}" method='POST'>
                @csrf
                @method('PUT')
                <div class="flex justify-center space-x-2">
                    <div class="mb-2 w-80">
<<<<<<< HEAD
                        <label class="block mb-2 text-sm font-medium text-gray-900 white:text-white">Description</label>
...
=======
                        <label class="block mb-2 text-sm font-medium text-gray-900 white:text-white">Decription</label>
                        <input name="description" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-blue-500 white:focus:border-blue-500 white:shadow-sm-light" value="{{$price_nodes->description}}">
>>>>>>> 70a5fcd151b7bbb208d81147b39be0c02ad2b8d2
                    </div>
