<x-app-layout>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            ...
            <div class="">
                <a href="{{ route('powerplant.create') }}" class=""> 
                    ...
                    @if(!empty($powerplant))
                        ...
                        <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 flex justify-center space-x-1">
                                <a href="{{ route('powerplant.edit',$p->id) }}" class="">
                                ...
                                <a href="{{ route('destroyPoweplant',['id'=>$p->id]) }}" onclick="return confirm('Are you sure you want to delete this record?');">
