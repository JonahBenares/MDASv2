            ...
            <table class="w-full text-sm text-left text-gray-500 white:text-gray-400">
                ...
                @foreach($loadArray AS $sl)
                    ...
                    <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                        ...
                        <td class="px-1 py-1 border" align="center">{{ number_format(getLoadbidEN($sl->time_interval,$sl->grid_id,'En'),2) }}</td>
                        <td class="px-1 py-1 border" align="center">{{ number_format(getLoadCurtailedEN($sl->time_interval,$sl->grid_id,'En'),2) }}</td>
