<x-app-layout>
   <div class="p-4">
      ...
      <div class="w-full flex justify-between space-x-2 border-b pb-4">
         ...
         <div class="w-40">
            <select class="block py-2.5 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 white:text-gray-400 focus:outline-none white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400" > 
