...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            <div class="text-lg  font-medium uppercase py-2">Power Plant <span class="bg-indigo-500 rounded-2xl p-1 px-2 font-bold text-white text-xs">Update</span></div>
            <div class="">
        ...
        <div class="relative overflow-x-auto border-b mb-2 pb-4">
            <form class="mx-20">
                ...
                <div class="flex justify-end space-x-2 mt-2">
                    <button type="submit" class="mb-2 w-2/12 text-white bg-indigo-600 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center white:bg-indigo-600 white:hover:bg-indigo-600 white:focus:ring-indigo-800">Update</button>
                </div>
            </form>
        </div>
    </div>
