    ...
    <div class="p-4 ">
        <div class="pb-4 flex justify-between">
            ...
            <div class="flex justify-between space-x-2 ">
                <a href="<?php echo e(route('uploadschedules.index')); ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 text-center">Upload New</a>
                <div>
                    <form action="<?php echo e(route('uploadschedules.search')); ?>" method="GET" class='flex justify-between space-x-2 w-60' onSubmit="return selectValidationDT();">
                        ...
                        <input type="hidden" name='identifier' id='identifier' value='<?php echo e($identifier); ?>'>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div id="alert-border-5" class="flex p-4 border-t-4 mb-4 shadow-md border-gray-300 bg-gray-50 white:bg-gray-800 white:border-gray-600" role="alert">
            ...
            <div class="ml-3 text-sm font-medium text-gray-800 white:text-gray-300 space-x-5">
                <?php if(isset($_GET['filter'])): ?>
                <span><b>Filter:</b> <?php echo e($_GET['filter']); ?></span> 
                <?php endif; ?>
            </div>
            <a  type="button" href="<?php echo e(route('uploadschedules.show', $_GET['identifier'])); ?>" class="ml-auto -mx-1.5 -my-1.5 bg-gray-50 text-gray-500 rounded-lg focus:ring-2 focus:ring-gray-400 p-1.5 hover:bg-gray-200 inline-flex h-8 w-8 white:bg-gray-800 white:text-gray-300 white:hover:bg-gray-700 white:hover:text-white" data-dismiss-target="#alert-border-5" aria-label="Close" onclick='return selectValidationDT();'>
        ...
        <span class='hide_paginate' onclick='return selectValidationDT();'><?php echo $scheduleload->links(); ?></span>
        </div>
        </div>
