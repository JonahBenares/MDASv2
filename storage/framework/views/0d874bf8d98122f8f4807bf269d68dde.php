...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            <div class="text-lg  font-medium uppercase py-2">Commodity <span class="bg-indigo-500 rounded-2xl p-1 px-2 font-bold text-white text-xs">Update</span></div>
            <div class="">
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\MDASv2\resources\views/mf_commodity/edit.blade.php ENDPATH**/ ?>