...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            ...
            <div class="">
                <a href="<?php echo e(route('location.create')); ?>" class=""> 
                ...
                <tbody>
                    <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4 flex justify-center space-x-1">
                            <a href="<?php echo e(route('location.edit','1')); ?>" class="">
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\MDASv2\resources\views/mf_location/index.blade.php ENDPATH**/ ?>