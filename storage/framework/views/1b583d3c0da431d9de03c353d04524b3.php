                        ...
                        <?php $__currentLoopData = $loadregionalArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($x % 12 == 0): ?>
                                ...
                                <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                    ...
                                    <td class="px-1 py-1 border" align="center"><?php echo e(number_format(getAvgRegionalAvg($rl->time_interval,$grid_id,'En','load_bid'),2)); ?></td>
                                    <td class="px-1 py-1 border" align="center"><?php echo e(number_format(getAvgRegionalAvg($rl->time_interval,$grid_id,'En','load_curtailed'),2)); ?></td>
