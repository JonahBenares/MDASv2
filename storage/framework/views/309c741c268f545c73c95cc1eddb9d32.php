...
<?php $component->withAttributes([]); ?>
    ...
    <div class="p-4 ">
        <div class="pb-2 flex justify-between border-b ">
            <div class="text-lg font-medium uppercase align-baseline inline-block leading-none py-3">Prices & Schedule & Load <b>(WEEKLY)</b></div>
        ...
        <form method="POST" action="<?php echo e(route('filter_scheduleloadweekly')); ?>" onSubmit="return selectValidation();">
            <?php echo csrf_field(); ?>
        ...
        <div class="">
            <div id="alert-border-5" class="flex p-4 border-t-4 mb-4 shadow-md border-gray-300 bg-gray-50 white:bg-gray-800 white:border-gray-600" role="alert">
                ...
                <div class="ml-3 text-sm font-medium text-gray-800 white:text-gray-300 space-x-5">
                    ...
                    <span><b>Intervals:</b> <?php echo e($_POST['date_from']." - ".$_POST['date_to']); ?></span> 
                    <?php endif; ?>
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/report_sched_weekly/index.blade.php ENDPATH**/ ?>