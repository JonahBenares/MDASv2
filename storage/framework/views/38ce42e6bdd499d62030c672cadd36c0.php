...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            <div class="text-lg  font-medium uppercase py-2">Price Nodes <span class="bg-blue-500 rounded-2xl p-1 px-2 font-bold text-white text-xs">Add new</span></div>
            <div class="">
        ...
        <div class="relative overflow-x-auto border-b mb-2 pb-4">
            ...
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('pricenodes.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/mf_pricenodes/create.blade.php ENDPATH**/ ?>