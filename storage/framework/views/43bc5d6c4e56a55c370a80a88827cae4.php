...
<?php $component->withAttributes([]); ?>
    ...
    <div class="p-4 ">
        ...
        <form method="POST" action="<?php echo e(route('filter_scheduleload')); ?>" onSubmit="return selectValidation();">
            <?php echo csrf_field(); ?>
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 white:bg-gray-700 white:text-gray-400 sticky top-0 z-10">
                    <tr>
                        <th scope="col" class="px-1 py-1 border align-bottom sticky left-0 bg-gray-50" colspan="3" align="right">Interval</th>
                            ...
                            <th scope="col" class="px-1 py-1 border align-bottom" colspan="24" align="center"><?php echo e($ih->run_hour); ?></th>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <th scope="col" class="px-1 py-1 border align-bottom" colspan="24" align="center"><?php echo e(((date("H", mktime($time+1))!='00') ? ltrim(date("H", mktime($time+1)),"0") : '24')); ?></th>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                    </tr>
                    <tr>
                        <th scope="col" class="px-1 py-1 border align-bottom sticky left-0 bg-gray-50" colspan="3" align="right">Minute</th>
                            <?php $__currentLoopData = $loadintervalArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ihs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                <?php for($time=5;$time<=60;$time+=5): ?>
                                    <th scope="col" class="px-1 py-1 border" colspan="2" align="center"><?php echo e(($time!='60') ? $time : '00'); ?></th>
                                <?php endfor; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <!-- <?php $__currentLoopData = range(intval('00:00:00'),intval('23:00:00')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                            <?php for($time=5;$time<=60;$time+=5): ?>
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-1 py-1 border align-bottom sticky left-[0px] bg-white" align="center">Resource_Name</th>
                            ...
                            <?php $__currentLoopData = $loadintervalArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ihsa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                <?php for($time=5;$time<=60;$time+=5): ?>
                ...
                <tbody>
                        <?php $__currentLoopData = $loadArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                <!-- <td scope="row" class="px-1 py-1 border align-bottom sticky left-[0px] bg-white" align="center"><?php echo e($sl->run_time); ?></td> -->
                                <td class="px-1 py-1 border align-bottom sticky left-[0px] bg-white" align="center"><?php echo e($sl->region_name); ?></td>
                                <td class="px-1 py-1 border align-bottom sticky left-[0px] bg-white" align="center"><?php echo e($sl->resource_type); ?></td>
                                <td class="px-1 py-1 border align-bottom sticky left-[0px] bg-white <?php echo e((!empty(getResourcecolor($sl->resource_name))) ? 'text-white' : ''); ?>" align="center" style="background:<?php echo e(getResourcecolor($sl->resource_name)); ?>"><?php echo e($sl->resource_name); ?></td>
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/report_schedule/index.blade.php ENDPATH**/ ?>