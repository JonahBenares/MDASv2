...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            <div class="text-lg  font-medium uppercase py-2">Price Nodes</div>
            <div class="">
                <a href="<?php echo e(route('pricenodes.create')); ?>" class=""> 
        ...
        <div class="relative overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 white:text-gray-400 " id="table-01">
                ...
                <tbody>
                    <?php $__currentLoopData = $price_nodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                        <td class="px-6 py-4">
                            <?php echo e($pn->description); ?>

                        </td>
                        <td class="px-6 py-4 flex justify-center space-x-1">
                            <a href="<?php echo e(route('pricenodes.edit',$pn->id)); ?>" class="">
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/mf_pricenodes/index.blade.php ENDPATH**/ ?>