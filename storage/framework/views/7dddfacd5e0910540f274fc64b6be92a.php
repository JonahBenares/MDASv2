...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            <div class="text-lg  font-medium uppercase py-2">Grid</div>
            <div class="">
                <a href="<?php echo e(route('grid.create')); ?>" class=""> 
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                        <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap white:text-white">
                            <?php echo e($g->grid_code); ?>

                        </td>
                        <td class="px-6 py-4">
                            <?php echo e($g->grid_name); ?>

                        </td>
                        <td class="px-6 py-4 flex justify-center space-x-1">
                            <a href="<?php echo e(route('grid.edit',$g->id)); ?>" class="">
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/mf_grid/index.blade.php ENDPATH**/ ?>