        ...
        <div class="relative w-full h-full max-w-lg md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow white:bg-gray-700">
                ...
                <form >
                    ...
                    <!-- Modal body -->
                    <div class="px-6">
                        <input type="text" name="reminder_date" class="block text-sm w-full px-3 py-2 mt-2 mb-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40" placeholder="Type">
                        <span class="">Color</span>
                        <input type="color" name="reminder" class="block text-sm w-full h-10 p-1  text-gray-600  bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                    </div>
                    <!-- Modal footer -->
                    <div class="flex items-center p-6 space-x-2">
                        <button data-modal-hide="addType" class="px-3 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-500 rounded-3xl w-full white:bg-blue-600 white:hover:bg-blue-700 white:focus:bg-blue-700 hover:bg-blue-600 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-50">Add</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="relative w-full h-full max-w-lg md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow white:bg-gray-700">
                ...
                <form >
                    ...
                    <!-- Modal body -->
                    <div class="px-6">
                        <input type="text" name="reminder_date" class="block text-sm w-full px-3 py-2 mt-2 mb-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40" placeholder="Sub Type">
                    </div>
                    <!-- Modal footer -->
                    <div class="flex items-center p-6 space-x-2">
                        <button data-modal-hide="addSub" class="px-3 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-500 rounded-3xl w-full white:bg-blue-600 white:hover:bg-blue-700 white:focus:bg-blue-700 hover:bg-blue-600 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-50">Add</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="relative w-full h-full max-w-lg md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow white:bg-gray-700">
                ...
                <form >
                    ...
                    <!-- Modal footer -->
                    <div class="flex items-center p-6 space-x-2">
                        <button data-modal-hide="updateSub" class="px-3 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-indigo-500 rounded-3xl w-full white:bg-indigo-600 white:hover:bg-indigo-700 white:focus:bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">Update</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="w-10/12  ">
                <div class="flex justify-start space-x-2 overflow-x-auto">
                    <div class="flex justify-center border border-gray-100 shadow-md rounded-lg mb-2">
                        <a href="" class="text-gray-900 bg-white font-medium rounded-lg rounded-r-none text-sm text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <span class="w-5 bg-[#5521B5] rounded-r-none rounded-lg px-4 py-2 mr-2"><br></span> Biomass
                        </a>
                        <button href="" data-dropdown-toggle="dropdwon1" class="w-auto text-gray-900 bg-white  font-medium rounded-lg rounded-l-none text-sm px-1 py-2 text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                            </svg>
                        </button>
                        <div id="dropdwon1" class="z-10 hidden font-normal bg-white  rounded-lg shadow w-auto white:bg-gray-700 white:divide-gray-600 mt-10">
                            <ul class="py-2 text-sm text-gray-700 white:text-gray-400" aria-labelledby="dropdownLargeButton">
                                  <li>
                                    <a data-modal-target="updateType" data-modal-toggle="updateType" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Update</a>
                                  </li>
                                <li>
                                    <a href="" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Delete</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center border border-gray-100 shadow-md rounded-lg mb-2">
                        <a href="" class="text-gray-900 bg-white font-medium rounded-lg rounded-r-none text-sm text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <span class="w-5 bg-[#723B13] rounded-r-none rounded-lg px-4 py-2 mr-2"><br></span> Coal
                        </a>
                        <button type="button" data-dropdown-toggle="dropdwon" class="w-auto text-gray-900 bg-white  font-medium rounded-lg rounded-l-none text-sm px-1 py-2 text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                            </svg>
                        </button>
                        <div id="dropdwon" class="z-10 hidden font-normal bg-white  rounded-lg shadow w-auto white:bg-gray-700 white:divide-gray-600 mt-10">
                            <ul class="py-2 text-sm text-gray-700 white:text-gray-400" aria-labelledby="dropdownLargeButton">
                                  <li>
                                    <a data-modal-target="updateType" data-modal-toggle="updateType" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Update</a>
                                  </li>
                    ...
                    <div class="flex justify-center border border-gray-100 shadow-md rounded-lg mb-2">
                        <a href="" class="text-gray-900 bg-white font-medium rounded-lg rounded-r-none text-sm text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <span class="w-5 bg-[#374151] rounded-r-none rounded-lg px-4 py-2 mr-2"><br></span> Geothermal
                        </a>
                        <button type="button" data-dropdown-toggle="dropdwon" class="w-auto text-gray-900 bg-white  font-medium rounded-lg rounded-l-none text-sm px-1 py-2 text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                    ...
                    <div class="flex justify-center border border-gray-100 shadow-md rounded-lg mb-2">
                        <a href="" class="text-gray-900 bg-white font-medium rounded-lg rounded-r-none text-sm text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <span class="w-5 bg-[#1E429F] rounded-r-none rounded-lg px-4 py-2 mr-2"><br></span> Hydro Electric
                        </a>
                        <button type="button" data-dropdown-toggle="dropdwon" class="w-auto text-gray-900 bg-white  font-medium rounded-lg rounded-l-none text-sm px-1 py-2 text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                    ...
                    <div class="flex justify-center border border-gray-100 shadow-md rounded-lg mb-2">
                        <a href="" class="text-gray-900 bg-white font-medium rounded-lg rounded-r-none text-sm text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <span class="w-5 bg-[#FACA15] rounded-r-none rounded-lg px-4 py-2 mr-2"><br></span> Natural Gas
                        </a>
                        <button type="button" data-dropdown-toggle="dropdwon" class="w-auto text-gray-900 bg-white  font-medium rounded-lg rounded-l-none text-sm px-1 py-2 text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                    ...
                    <div class="flex justify-center border border-gray-100 shadow-md rounded-lg mb-2">
                        <a href="" class="text-gray-900 bg-white font-medium rounded-lg rounded-r-none text-sm text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <span class="w-5 bg-[#9B1C1C] rounded-r-none rounded-lg px-4 py-2 mr-2"><br></span> Oil-Based
                        </a>
                        <button type="button" data-dropdown-toggle="dropdwon" class="w-auto text-gray-900 bg-white  font-medium rounded-lg rounded-l-none text-sm px-1 py-2 text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                    ...
                    <div class="flex justify-center border border-gray-100 shadow-md rounded-lg mb-2">
                        <a href="" class="text-gray-900 bg-white font-medium rounded-lg rounded-r-none text-sm text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <span class="w-5 bg-[#ff6c0a] rounded-r-none rounded-lg px-4 py-2 mr-2"><br></span> Solar
                        </a>
                        <button type="button" data-dropdown-toggle="dropdwon" class="w-auto text-gray-900 bg-white  font-medium rounded-lg rounded-l-none text-sm px-1 py-2 text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                    ...
                    <div class="flex justify-center border border-gray-100 shadow-md rounded-lg mb-2">
                        <a href="" class="text-gray-900 bg-white font-medium rounded-lg rounded-r-none text-sm text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <span class="w-5 bg-[#0ebeb0] rounded-r-none rounded-lg px-4 py-2 mr-2"><br></span> Wind
                        </a>
                        <button type="button" data-dropdown-toggle="dropdwon" class="w-auto text-gray-900 bg-white  font-medium rounded-lg rounded-l-none text-sm px-1 py-2 text-center inline-flex items-center white:focus:ring-gray-800 white:bg-white white:border-gray-700 white:text-gray-900 white:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                ...
                <tbody>
                    <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4 flex justify-center space-x-1">
                            <a data-modal-target="updateSub" data-modal-toggle="updateSub" class="">
