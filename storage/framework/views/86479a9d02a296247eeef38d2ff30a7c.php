...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div class="capitalize mr-2"><?php echo e(Auth::user()->name); ?></div>
...
<?php endif; ?>
                ...
                <li>
                    ...
                    <div id="dropdownNavMasterfile" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-auto white:bg-gray-700 white:divide-gray-600">
                        ...
                        <ul class="py-2 text-sm text-gray-700 white:text-gray-400" aria-labelledby="dropdownLargeButton">
                            <li>
                                <a href="<?php echo e(route('grid.index')); ?>" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Grid</a>
                            </li>
                          	<li>
                            ...
                            <li>
                            	<a href="<?php echo e(route('pricenodes.index')); ?>" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Price Nodes</a>
                          	</li>
                            <li>
                            ...
                            <li>
                            	<a href="<?php echo e(route('powerplant.index')); ?>" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Power Plant</a>
                          	</li>
                            <li>
                            	<a href="<?php echo e(route('powerplanttype.index')); ?>" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Power Plant Type</a>
                          	</li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div id="dropdownNavUpload" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-auto white:bg-gray-700 white:divide-gray-600">
                        ...
                        <ul class="py-2 text-sm text-gray-700 white:text-gray-400" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                            	<a href="<?php echo e(route('uploadregional.index')); ?>" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Regional Summary</a>
                          	</li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div id="dropdownNavReports" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-auto white:bg-gray-700 white:divide-gray-600">
                        ...
                        <ul class="py-2 text-sm text-gray-700 white:text-gray-400" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                                <a href="<?php echo e(route('reportschedulesdaily.index')); ?>" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Prices & Schedule & Load <b>(Daily)</b></a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('reportschedulesweekly.index')); ?>" class="block px-4 py-2 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white">Prices & Schedule & Load <b>(Weekly)</b></a>
                            </li>
                            <li>
  ...
  <?php /**PATH C:\xampp\htdocs\MDASv2\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>