...
<?php $component->withAttributes([]); ?>
   <div class="p-4">
      ...
      <div class="w-full">
         <a href="<?php echo e(route('uploadregional.show', '1')); ?>" type="button" class="text-center w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Save File</a>
      </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/upload_regional/index.blade.php ENDPATH**/ ?>