...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        ...
        <div class="relative overflow-x-auto border-b mb-2 pb-4">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('region.update',$region->id)); ?>" method='POST'>
                <?php echo csrf_field(); ?>
