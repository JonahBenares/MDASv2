...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        ...
        <div class="relative overflow-x-auto border-b mb-2 pb-4">
            ...
            <?php endif; ?>
            <form class="mx-20" method="POST" action="<?php echo e(route('powerplant.update',$powerplant->id)); ?>" onsubmit="return confirm('Are you sure you want to proceed next?');">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex justify-between space-x-2">
                    ...
                    <div class="mb-2 w-3/12">
                        ...
                        <select name="connection_type" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-blue-500 white:focus:border-blue-500 white:shadow-sm-light">
                            ...
                            <option value="Grid Connected" <?php echo e(($powerplant->connection_type=='Grid Connected') ? 'selected' : ''); ?>>Grid Connected</option>
                            <option value="Embedded" <?php echo e(($powerplant->connection_type=='Embedded') ? 'selected' : ''); ?>>Embedded</option>
                        </select>
                    </div>
                </div>
                <div class="flex justify-between space-x-2">
                    <div class="mb-2 w-3/12">
                        ...
                        <select name="pp_type_id" id="type-dropdown" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-blue-500 white:focus:border-blue-500 white:shadow-sm-light">
                            ...
                            <?php $__currentLoopData = $powerplant_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pt->id); ?>" <?php echo e(($pt->id==$powerplant->pp_type_id) ? 'selected' : ''); ?>><?php echo e($pt->type_name); ?></option>
                    ...
                    <div class="mb-2 w-3/12">
                        ...
                        <select name="subtype_id" id="subtype-dropdown" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-blue-500 white:focus:border-blue-500 white:shadow-sm-light">
                            ...
                            <?php $__currentLoopData = $powerplant_subtype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($st->id); ?>" <?php echo e(($st->id==$powerplant->subtype_id) ? 'selected' : ''); ?>><?php echo e($st->subtype_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="mb-2 w-6/12">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 white:text-white">Operator</label>
                        <input name="operator" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-blue-500 white:focus:border-blue-500 white:shadow-sm-light" value="<?php echo e($powerplant->operator); ?>">
                    </div>
                </div>
                <div class="flex justify-between space-x-2">
                    <div class="mb-2 w-3/12">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 white:text-white">Location/Municipality</label>
                        <input name="municipality" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-blue-500 white:focus:border-blue-500 white:shadow-sm-light" value="<?php echo e($powerplant->municipality); ?>">
                    </div>
                    <div class="mb-2 w-3/12">
                        ...
                        <select name="grid_id" id="grid-dropdown" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-blue-500 white:focus:border-blue-500 white:shadow-sm-light">
                            ...
                            <?php $__currentLoopData = $grid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($g->id); ?>" <?php echo e(($g->id==$powerplant->grid_id) ? 'selected' : ''); ?>><?php echo e($g->grid_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="mb-2 w-3/12">
                ...
                <div class="flex justify-between space-x-2">
                    ...
                    <div class="mb-2 w-3/12">
                        ...
                        <select name="status" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-blue-500 white:focus:border-blue-500 white:shadow-sm-light">
                            ...
                            <option value="Active" <?php echo e(($powerplant->status=='Active') ? 'selected' : ''); ?>>Active</option>
                            <option value="Inactive" <?php echo e(($powerplant->status=='Inactive') ? 'selected' : ''); ?>>Inactive</option>
                        </select>
                    </div>
                </div>
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/power_plant/edit.blade.php ENDPATH**/ ?>