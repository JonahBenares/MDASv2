...
<?php $component->withAttributes([]); ?>
    <div class="p-4 ">
        <div class="mb-4 pb-2 flex justify-between border-b">
            <div class="text-lg  font-medium uppercase py-2">Location <span class="bg-blue-500 rounded-2xl p-1 px-2 font-bold text-white text-xs">Add new</span></div>
            <div class="">
                <a href="<?php echo e(route('location.index')); ?>" class=""> 
        ...
        <div class="relative overflow-x-auto border-b mb-2 pb-4">
            <form class="">
                <div class="flex justify-center space-x-2">
                    <div class="mb-2 w-60">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 white:text-white">Location</label>
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/mf_location/create.blade.php ENDPATH**/ ?>