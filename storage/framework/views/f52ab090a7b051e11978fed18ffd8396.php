...
<?php $component->withAttributes([]); ?>
    ...
    <div class="p-4 ">
        <div class="pb-2 flex justify-between border-b ">
            <div class="text-lg font-medium uppercase align-baseline inline-block leading-none py-3">Prices & Schedule & Load <b>(DAILY)</b></div>
        ...
        <form method="POST" action="<?php echo e(route('filter_scheduleloaddaily')); ?>" onSubmit="return selectValidation();">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
 <?php /**PATH C:\xampp\htdocs\mdasv2\resources\views/report_sched_daily/index.blade.php ENDPATH**/ ?>